...
def get_codes():
    df = pywencai.get(query='昨日未涨停，开盘涨跌幅>1且<8，9点25价格>9点24价格，流值<120亿，沪深主板,非st，股价>3且<30', loop=True, sort_order='desc', sort_key='最新涨跌幅', cookie=cookie)
...
def get_data(stock_list):
    ...
    my_df = my_df[(my_df['reversed_bytes9'] >= 1.5) & (my_df['zf'] > 9.5)]
