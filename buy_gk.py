...
def get_codes():
    global codes
    df = pywencai.get(query='沪深主板非st，昨日未涨停，前日未涨停，当前涨幅>1且<5，流值小于120亿，股价<20且>3，无可转债，今日最大涨幅<6', loop=True, sort_order='desc', sort_key='最新涨跌幅', pro=True, cookie=cookie)
